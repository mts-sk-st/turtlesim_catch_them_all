...
class TurtleControllerNode(Node):
    def __init__(self):
        ...
        self.control_loop_tiemr_ = self.create_timer(
            0.01, self.control_loop)
        self.get_logger().info("Trutle Contoller has been started...")
    ...
    def call_catch_turtle_service(self, turtle_name):
        while not self.catch_turtle_client_.wait_for_service(1.0):
            self.get_logger().info("Waiting for the catch turtle service...")
